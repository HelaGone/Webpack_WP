			...
			<section class="social_networks">
				<ul>
					<li class="social_icon">
						<a href="https://facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank" rel="noopener nofollow">
					...
					<li class="social_icon">
						<a href="https://twitter.com/intent/tweet?original_referer=<?php echo get_bloginfo('url'); ?>
							...
							&amp;url=<?php the_permalink(); ?>" title="compartir en Twitter" target="_blank" rel="noopener nofollow">
